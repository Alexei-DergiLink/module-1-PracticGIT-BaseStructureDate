...
name = "Aleksey" # создал переменную типа стринг (строка)
print (name, type(name)) # проверил ее вывод и тип name (Aleksey <class 'str'>)
age = int (30) # создал переменную целочисленных значений
print(age, type(age)) # проверил вывод и тип age 30 <class 'int'>
age = int (38) # перезаписал значение age на новое
print(age, type(age)) # вывел и проверил (38 <class 'int'>)
is_student = True # создал новую переменную с логическим типом
print(is_student, type(is_student)) # вывел значение переменной is_student на экран, а также ее тип (True <class 'bool'>)
